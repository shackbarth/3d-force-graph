...
import { AmbientLight, BufferAttribute, BufferGeometry, Color, DirectionalLight, Group, Line, LineBasicMaterial, Mesh, MeshLambertMaterial, PerspectiveCamera, Raycaster, Scene, SphereGeometry, Vector2, WebGLRenderer } from 'three';
...
var _3dForceGraph = Kapsule({
    ...
    init: function init(domNode, state) {
        ...
        // Setup scene
        var scene = new Scene();
        scene.background = new Color(0xb5c8d6);
        ...
        this.d3ForceLayout = state.d3ForceLayout = forceSimulation().force('link', forceLink()).force('charge', forceManyBody()).force('center', forceCenter()).stop();
    ...
    update: function updateFn(state) {
        ...
        state.graphData.nodes.forEach(function (node) {
            ...
            var sphere = new Mesh(sphereGeometries[val], sphereMaterials[color]);
